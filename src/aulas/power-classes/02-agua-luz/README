# Desafio proposto pela MJV para treinamento de Manipulação de arquivos,Conceitos de POO,Organização de Arquivos e métodos.


### Conceitos e tecnologias usadas na aplicacao:
<details>
1 - Encapsulamento
2 - Abstração
3 - Classes
...
O desafio segue como indicado abaixo:
